...
public static class PolyverseSkiesWindows
{
    ...
    {
        Application.OpenURL(
            "https://docs.google.com/document/d/1z7A_xKNa2mXhvTRJqyu-ZQsAtbV32tEZQbO1OmPS_-s/edit#heading=h.gqix7il7wlwd");
    }
    ...
    {
        Application.OpenURL(
            "https://docs.google.com/document/d/1z7A_xKNa2mXhvTRJqyu-ZQsAtbV32tEZQbO1OmPS_-s/edit#heading=h.1rbujejuzjce");
    }
    ...
    {
        Application.OpenURL(
            "https://assetstore.unity.com/packages/vfx/shaders/polyverse-skies-low-poly-skybox-shaders-and-textures-104017#reviews");
    }
}