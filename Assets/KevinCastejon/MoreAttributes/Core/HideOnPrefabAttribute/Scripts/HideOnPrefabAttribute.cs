...
{
    /// <summary>
    ///     Hides the property in PrefabMode. The behaviour can be inverted with the 'invert' parameter so the property is
    ///     visible only in PrefabMode.
    /// </summary>
    public class HideOnPrefabAttribute : PropertyAttribute
    {
        ...
        /// <summary>
        ///     Hide the property in PrefabMode. The behaviour can be inverted with the 'invert' parameter so the property is
        ///     visible only in PrefabMode.
        /// </summary>
