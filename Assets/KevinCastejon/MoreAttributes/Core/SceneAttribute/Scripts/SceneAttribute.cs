...
namespace KevinCastejon.MoreAttributes
{
    ...
    public class SceneAttribute : PropertyAttribute
    {
        ...
        ///     If true, the dropdown list will display a "
        ///     <Missing>
        ///         " field if the scene name does not match any build settings scene. If false, the dropdown list will select
        ///         the first item if the scene name does not match any build settings scene.
        /// </param>
